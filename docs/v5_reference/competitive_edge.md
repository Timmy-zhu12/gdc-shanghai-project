...
CardioConsult 被设计为离线 Gemma4 边缘 AI 应用，生态位是“便携式超声 + 本地离线 PC + 基层/教学场景”。项目面向只有无线或便携式超声设备、缺少完整心超工作站、缺少心血管超声专科医生的环境。它不是简单模型封装，也不是纯规则演示，而是把超声专用边缘特征、Gemma4 4B 函数调用、结构化报告推理、确定性安全守卫和多智能体审计组合成一个可部署在便携式超声旁的 Windows PC 离线分析终端。
...
2. 只依赖便携式超声的离线医疗教育场景。
   ...
   目标使用场景是医学教学和基层心脏超声参考，尤其是只有便携式或无线超声、没有完整心超工作站的环境。此类场景可能网络不稳定、缺少专科医生、且对隐私要求高。PC 可放在便携式超声旁，通过设备导出目录、DICOM 工作站或局域网共享目录直接读取资料，应用本地运行，不要求原始病人数据离开现场设备。
